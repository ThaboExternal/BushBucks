...
<main>
    <p>Add some things (results page)</p>
    <?php
$findM=strtotime("-6 month");
$foundM = date("Y-m-d", $findM) . "T" . date("h:i:s", $findM);
echo $foundM;
$urlm = "https://rest.coinapi.io/v1/ohlcv/BITSTAMP_SPOT_XRP_USD/history?period_id=1MTH&time_start=$foundM&apikey=D97DE1CA-908D-4512-A65C-DF091720909B";
