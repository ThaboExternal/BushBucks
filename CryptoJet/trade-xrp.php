...
$urld = "https://rest.coinapi.io/v1/ohlcv/BITSTAMP_SPOT_XRP_USD/history?period_id=1DAY&time_start=$foundD&apikey=8E08E111-7899-4FDF-B473-31F639928280";
//echo $urld;
...
$urlw = "https://rest.coinapi.io/v1/ohlcv/BITSTAMP_SPOT_XRP_USD/history?period_id=7DAY&time_start=$foundW&apikey=8E08E111-7899-4FDF-B473-31F639928280";
//echo $urlw;
...
$urlm = "https://rest.coinapi.io/v1/ohlcv/BITSTAMP_SPOT_XRP_USD/history?period_id=1MTH&time_start=$foundM&apikey=8E08E111-7899-4FDF-B473-31F639928280";
//echo $urlm;
...
?> 
  ...
  <?php
        ...
        echo "<li class=\"nav-item me-3 me-lg-1\">";
        echo "<a class=\"nav-link\" href=\"trade-xrp.php?id=" . $_REQUEST['id'] . "\">";
    ...
    echo"<ul class=\"navbar-nav flex-row\">";
        ...
        echo "<style> .dropbtn
          ...
          echo "<li class=\"nav-item me-3 me-lg-1\">";
          echo "<a class=\"nav-link\" href=\"trade-xrp.php\">";
          echo "<span><img src=\"extra/monero.svg\" height=\"20\" alt=\"\" style=\"margin-top: 2px;\"/></span>";
          echo "</a>";
          echo "</li>";
          echo "</ul>";
...
echo "<li style=\"float: left;\"><a href=\"trade-eth.php?id=". $_REQUEST['id'] . "\">ETH</a></li>";
echo "<li style=\"float: left;\"><a class=\"active\" href=\"trade-xrp.php?id=". $_REQUEST['id'] . "\">XRP</a></li>";
...
echo "<li style=\"float: left;\"><a href=\"trade-eth.php\">ETH</a></li>";
echo "<li style=\"float: left;\"><a class=\"active\" href=\"trade-xrp.php\">XRP</a></li>";
...
<div class="card text-center" style="margin-right: 300px;
  ...
  margin-left: 300px;
  padding: 10px;">
    <h2 class="card-title">How much Ripple do you want to Buy or Sell ?</h2>

<?php  

if(isset($_REQUEST['id'])){

    echo "<form action=\"trade-xrp.php\" method=\"POST\">
...
<!-- deal with instant buy or sell -->
        ...
        $x1 = file_get_contents('https://rest.coinapi.io/v1/exchangerate/USD/XRP?apikey=D97DE1CA-908D-4512-A65C-DF091720909B');
        ...
        $query3 = "INSERT INTO transaction(transId, cryptoId, tranHist, limitP,userId, balance, descrip)
                   VALUE('$count', '$cryptoId', '$date', '$amount', '$id', '$balance', '$des')";
        ...
        $text = "An immediate-Or-Cancel buy transaction for XRP was completed on the $date . \n";
        ...
        echo "<script> window.location.href =\"wallet.php?id=" . $_REQUEST['custId'] . "\"</script>";
          ...
          $text = "An immediate-Or-Cancel sell transaction for XRP was cancelled on the $date . \n";
          ...
          fclose($file);
          //close the report
            echo "<script> window.location.href =\"trade-xrp.php?id=" . $_REQUEST['custId'] . "\"</script>";
            ...
            $query6 = "INSERT INTO transaction(transId, cryptoId, tranHist, limitP,userId, balance, descrip)
                   VALUE('$count', '$cryptoId', '$date', '$amount', '$id', '$balance', '$des')";
          ...
          $text = "An immediate-Or-Cancel sell transaction for XRP was completed on the $date . \n";
...
<!-- deal with stop order buy and sell -->
        ...
        $x2 = file_get_contents('https://rest.coinapi.io/v1/exchangerate/XRP/USD?apikey=D97DE1CA-908D-4512-A65C-DF091720909B');
        ...
        $query8 = "INSERT INTO  transaction(transId, cryptoId, tranHist, stopL, limitP, userId, descrip)
                VALUE('$count', '$cryptoId', '$date', '$totprice', '$amount', '$id', '$des')";
        ...
        $result8 = mysqli_query($conn3, $query8) or die("ERROR: unable to add transaction (buy order)!");
          ...
          $text = "A Stop-limit order [BUY] for XRP was created on the $date . \n";
        ...
        //insert into transaction table, and then display on active.php
        // when totprice hits, make transaction happen, and change wallet
        $query9 = "INSERT INTO  transaction(transId, cryptoId, tranHist, stopL, limitP, userId, descrip)
                    VALUE('$count', '$cryptoId', '$date', '$totprice', '$amount' ,'$id', '$des')";
        ...
        // create long report
          ...
          $text = "A Stop-limit order [SELL] for XRP was created on the $date . \n";
