...
<main>
    <p>Add some things (notify page)</p>

    <?php 

//get the results for the day

$xml = file_get_contents('https://api.polygon.io/v2/aggs/ticker/X:BTCUSD/range/1/day/2021-08-01/2021-08-30?adjusted=true&sort=asc&limit=120&apiKey=Qp2MfbUaV11zZkQgiwlYwpJrCXepDESW');

//$xml = file_get_contents('https://api.polygon.io/v1/open-close/crypto/BTC/USD/2021-09-07?adjusted=true&apiKey=Qp2MfbUaV11zZkQgiwlYwpJrCXepDESW');
/*
...
//echo $xml['10'];
//average for the day
//echo (($data['open'] + $data['close']) /2);

//echo $data['rate']; https://rest.coinapi.io/v1/exchangerate/USD/BTC?apikey=D97DE1CA-908D-4512-A65C-DF091720909B
