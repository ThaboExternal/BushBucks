...
$urlh = "https://rest.coinapi.io/v1/ohlcv/BITSTAMP_SPOT_USDC_USD/history?period_id=4HRS&time_start=$foundH&apikey=8E08E111-7899-4FDF-B473-31F639928280";
//echo $urlh;
...
$urld = "https://rest.coinapi.io/v1/ohlcv/BITSTAMP_SPOT_USDC_USD/history?period_id=1DAY&time_start=$foundD&apikey=8E08E111-7899-4FDF-B473-31F639928280";
//echo $urld;
...
$urlw = "https://rest.coinapi.io/v1/ohlcv/BITSTAMP_SPOT_USDC_USD/history?period_id=7DAY&time_start=$foundW&apikey=8E08E111-7899-4FDF-B473-31F639928280";
//echo $urlw;
...
$urlm = "https://rest.coinapi.io/v1/ohlcv/BITSTAMP_SPOT_USDC_USD/history?period_id=1MTH&time_start=$foundM&apikey=8E08E111-7899-4FDF-B473-31F639928280";
//echo $urlm;
...
?> 
  ...
  <?php
        ...
        echo "<li class=\"nav-item me-3 me-lg-1\">";
        echo "<a class=\"nav-link\" href=\"trade-usdc.php?id=" . $_REQUEST['id'] . "\">";
    ...
    echo"<ul class=\"navbar-nav flex-row\">";
        ...
        echo "<style> .dropbtn
          ...
          echo "<li class=\"nav-item me-3 me-lg-1\">";
          echo "<a class=\"nav-link\" href=\"trade-usdc.php\">";
          echo "<span><img src=\"extra/monero.svg\" height=\"20\" alt=\"\" style=\"margin-top: 2px;\"/></span>";
          echo "</a>";
          echo "</li>";
          echo "</ul>";
...
echo "<li style=\"float: left;\"><a class=\"active\" href=\"trade-usdc.php?id=". $_REQUEST['id'] . "\">USDC</a></li>";
...
echo "<li style=\"float: left;\"><a class=\"active\" href=\"trade-usdc.php\">USDC</a></li>";
...
<div class="card text-center" style="margin-right: 300px;
  ...
  margin-left: 300px;
  padding: 10px;">
    <h2 class="card-title">How much USD Coin do you want to Buy or Sell ?</h2>

<?php  

if(isset($_REQUEST['id'])){

    echo "<form action=\"trade-usdc.php\" method=\"POST\">
...
<!-- deal with instant buy or sell -->
        ...
        $x1 = file_get_contents('https://rest.coinapi.io/v1/exchangerate/USD/USDC?apikey=D97DE1CA-908D-4512-A65C-DF091720909B');
        ...
        $text = "An immediate-Or-Cancel buy transaction for USDC was completed on the $date . \n";
        ...
        echo "<script> window.location.href =\"wallet.php?id=" . $_REQUEST['custId'] . "\"</script>";
          ...
          $text = "An immediate-Or-Cancel sell transaction for USDC was cancelled on the $date . \n";
          ...
          fclose($file);
          //close the report
            echo "<script> window.location.href =\"trade-usdc.php?id=" . $_REQUEST['custId'] . "\"</script>";
          ...
          $text = "An immediate-Or-Cancel sell transaction for USDC was completed on the $date . \n";
...
<!-- deal with stop order buy and sell -->
        ...
        $x2 = file_get_contents('https://rest.coinapi.io/v1/exchangerate/USDC/USD?apikey=D97DE1CA-908D-4512-A65C-DF091720909B');
        ...
        $result8 = mysqli_query($conn3, $query8) or die("ERROR: unable to add transaction (buy order)!");
          ...
          $text = "A Stop-limit order [BUY] for USDC was created on the $date . \n";
        ...
        // create long report
          ...
          $text = "A Stop-limit order [SELL] for USDC was created on the $date . \n";
