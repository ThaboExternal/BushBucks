...
?> 
  ...
  <?php
          ...
          $query1 ="SELECT fname, lname, prefcoin FROM customer WHERE clientId = $id";
...
$x1 = file_get_contents('https://rest.coinapi.io/v1/exchangerate/BTC/USD?apikey=D97DE1CA-908D-4512-A65C-DF091720909B');
$d1 = json_decode($x1, TRUE);

$x2 = file_get_contents('https://rest.coinapi.io/v1/exchangerate/LTC/USD?apikey=D97DE1CA-908D-4512-A65C-DF091720909B');
$d2 = json_decode($x2, TRUE);

$x3 = file_get_contents('https://rest.coinapi.io/v1/exchangerate/ETH/USD?apikey=D97DE1CA-908D-4512-A65C-DF091720909B');
$d3 = json_decode($x3, TRUE);

$x4 = file_get_contents('https://rest.coinapi.io/v1/exchangerate/XRP/USD?apikey=D97DE1CA-908D-4512-A65C-DF091720909B');
$d4 = json_decode($x4, TRUE);

$x5 = file_get_contents('https://rest.coinapi.io/v1/exchangerate/USDC/USD?apikey=D97DE1CA-908D-4512-A65C-DF091720909B');
$d5 = json_decode($x5, TRUE);

$x6 = file_get_contents('https://rest.coinapi.io/v1/exchangerate/XMR/USD?apikey=D97DE1CA-908D-4512-A65C-DF091720909B');
...
$xmr =  $d6['rate'];//XMR
    ...
    if (isset($_REQUEST['id'])) {
        ...
        echo "<h2>Account holder: $full</h2>";
        echo "<br>";
        echo "<br>";
      ...
      while($coin != 7){
          ...
          $query = "SELECT balance FROM wallet
            WHERE userId = '$find' AND  cryptoId = '$coin'";
          
          if($coin == 1){
            $result1 = mysqli_query($conn, $query) or die("ERROR: unable to execute query! (get balance wallet.php)");
            $row1 = mysqli_fetch_array($result1);
            $balance1 = $row1['balance'];
            $hold1 = $btc * $balance1;
          }elseif ($coin == 2) {
            $result2 = mysqli_query($conn, $query) or die("ERROR: unable to execute query! (get balance wallet.php)");
            $row2 = mysqli_fetch_array($result2);
            $balance2 = $row2['balance'];
            $hold2 = $ltc * $balance2;
          }elseif ($coin == 3) {
            $result3 = mysqli_query($conn, $query) or die("ERROR: unable to execute query! (get balance wallet.php)");
            $row3 = mysqli_fetch_array($result3);
            $balance3 = $row3['balance'];
            $hold3 = $eth * $balance3;
          }elseif ($coin == 4) {
            $result4 = mysqli_query($conn, $query) or die("ERROR: unable to execute query! (get balance wallet.php)");
            $row4 = mysqli_fetch_array($result4);
            $balance4 = $row4['balance'];
            $hold4 = $xrp * $balance4;
          }elseif ($coin == 5) {
            $result5 = mysqli_query($conn, $query) or die("ERROR: unable to execute query! (get balance wallet.php)");
            $row5 = mysqli_fetch_array($result5);
            $balance5 = $row5['balance'];
            $hold5 = $usdc * $balance5;
          }elseif ($coin == 6) {
            $result6 = mysqli_query($conn, $query) or die("ERROR: unable to execute query! (get balance wallet.php)");
            $row6 = mysqli_fetch_array($result6);
            $balance6 = $row6['balance'];
            $hold6 = $xmr * $balance6;
          }
...
//balance is how much coin you have
// hold is how much it actually is worth currently
echo "<div class=\"row\">";
echo "<div class=\"column\">";
echo "<div class=\"card\">";
echo "<h3>BTC</h3>";
echo "<p>Balance: $$hold1 </p>";
echo "<p>$balance1 BTC</p>";
echo "</div>";
echo "</div>";
...
echo "<div class=\"card\">";
echo "<h3>LTC</h3>";
echo "<p>Balance: $$hold2 </p>";
echo "<p>$balance2 LTC</p>";
echo "</div>";
echo "</div>";
...
echo "<div class=\"card\">";
echo "<h3>ETH</h3>";
echo "<p>Balance: $$hold3 </p>";
echo "<p>$balance3 ETH</p>";
echo "</div>";
echo "</div>";
echo "</div>";
...
echo "<div class=\"card\">";
echo "<h3>XRP</h3>";
echo "<p>Balance: $$hold4 </p>";
echo "<p>$balance4 XRP</p>";
echo "</div>";
echo "</div>";
...
echo "<div class=\"card\">";
echo "<h3>USDC</h3>";
echo "<p>Balance: $$hold5 </p>";
echo "<p>$balance5 USDC</p>";
echo "</div>";
echo "</div>";
...
echo "<div class=\"card\">";
echo "<h3>XMR</h3>";
echo "<p>Balance: $$hold6 </p>";
echo "<p>$balance6 XMR</p>";
echo "</div>";
echo "</div>";
echo "</div>";    
