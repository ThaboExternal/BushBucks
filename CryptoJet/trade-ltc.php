...
$urld = "https://rest.coinapi.io/v1/ohlcv/BITSTAMP_SPOT_LTC_USD/history?period_id=1DAY&time_start=$foundD&apikey=8E08E111-7899-4FDF-B473-31F639928280";
//echo $urld;
...
$urlw = "https://rest.coinapi.io/v1/ohlcv/BITSTAMP_SPOT_LTC_USD/history?period_id=7DAY&time_start=$foundW&apikey=8E08E111-7899-4FDF-B473-31F639928280";
//echo $urlw;
...
$urlm = "https://rest.coinapi.io/v1/ohlcv/BITSTAMP_SPOT_LTC_USD/history?period_id=1MTH&time_start=$foundM&apikey=8E08E111-7899-4FDF-B473-31F639928280";
//echo $urlm;
...
?> 
  ...
  <?php
        ...
        echo "<li class=\"nav-item me-3 me-lg-1\">";
        echo "<a class=\"nav-link\" href=\"trade-ltc.php?id=" . $_REQUEST['id'] . "\">";
    ...
    echo"<ul class=\"navbar-nav flex-row\">";
        ...
        echo "<style> .dropbtn
          ...
          echo "<li class=\"nav-item me-3 me-lg-1\">";
          echo "<a class=\"nav-link\" href=\"trade-ltc.php\">";
          echo "<span><img src=\"extra/monero.svg\" height=\"20\" alt=\"\" style=\"margin-top: 2px;\"/></span>";
          echo "</a>";
          echo "</li>";
          echo "</ul>";
...
echo "<li style=\"float: left;\"><a class=\"active\" href=\"trade-ltc.php?id=". $_REQUEST['id'] . "\">LTC</a></li>";
...
echo "<li style=\"float: left;\"><a class=\"active\" href=\"trade-ltc.php\">LTC</a></li>";
...
<div class="card text-center" style="margin-right: 300px;
  ...
  margin-left: 300px;
  padding: 10px;">
    <h2 class="card-title">How much Litecoin do you want to Buy or Sell ?</h2>

<?php 
 
if(isset($_REQUEST['id'])){

    echo "<form action=\"trade-ltc.php\" method=\"POST\">
...
<!-- deal with instant buy or sell -->
        ...
        $x1 = file_get_contents('https://rest.coinapi.io/v1/exchangerate/USD/LTC?apikey=D97DE1CA-908D-4512-A65C-DF091720909B');
        ...
        $text = "An immediate-Or-Cancel buy transaction for LTC was completed on the $date . \n";
        ...
        echo "<script> window.location.href =\"wallet.php?id=" . $_REQUEST['custId'] . "\"</script>";
          ...
          $text = "An immediate-Or-Cancel sell transaction for LTC was cancelled on the $date . \n";
          ...
          fclose($file);
          //close the report
            echo "<script> window.location.href =\"trade-ltc.php?id=" . $_REQUEST['custId'] . "\"</script>";
          ...
          $text = "An immediate-Or-Cancel sell transaction for LTC was completed on the $date . \n";
...
<!-- deal with stop order buy and sell -->
        ...
        $result8 = mysqli_query($conn3, $query8) or die("ERROR: unable to add transaction (buy order)!");
          ...
          $text = "A Stop-limit order [BUY] for LTC was created on the $date . \n";
        ...
        // create long report
          ...
          $text = "A Stop-limit order [SELL] for LTC was created on the $date . \n";
