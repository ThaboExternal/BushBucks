...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
 ...
 <?php
      if (isset($_REQUEST['ua'])) {
        echo "<a class=\"navbar-brand me-2 mb-1 d-flex align-items-center\" href=\"index.php?id=" . $_REQUEST['ua'] . "\">";
    ...
    <ul class="navbar-nav flex-row d-none d-md-flex">
      ...
      <?php
        ...
        if(isset($_REQUEST['ua'])){
          ...
          $query ="SELECT fname, prefcoin FROM customer WHERE clientId = $id";
        ...
        echo "<a class=\"nav-link\" href=\"index.php?id=" . $_REQUEST['ua'] . "\">";
        ...
        echo "<a class=\"nav-link\" href=\"wallet.php?id=" . $_REQUEST['ua'] . "\">";
        ...
        echo "<li class=\"nav-item me-3 me-lg-1\">";
        echo "<a class=\"nav-link\" href=\"active.php?id=" . $_REQUEST['ua'] . "\">";
        ...
        echo "<li class=\"nav-item me-3 me-lg-1\">";
        echo "<a class=\"nav-link\" href=\"trade-$prefcoin.php?id=" . $_REQUEST['ua'] . "\">";
...
<main>
<!-- Update records-->
<!-- if not update, then delete (you will see on admin.php that a different var is sent to this page if delete needed) -->
    <?php
            require_once("config.php");
            ...
            if (isset($_REQUEST['ua'])) {
                ...
                $query2 = "SELECT * FROM customer WHERE clientId = $ch";
                
                $result2 = mysqli_query($conn2, $query2) or die("ERROR: unable to execute query!");
                
                
                echo "<h1><strong>" . "Update Details:" . "</strong></h1>";
                echo "<br>";
                while ($row = mysqli_fetch_array($result2)) {
                        echo "<h1 style=\"font-size:1.25em;\"><strong>" . $row['fname'] . " " .$row['lname']."</strong></h1>";
                    ...
                    <select id=\"prefcoin\" name=\"prefcoin\">
                        ...
                        <input id=\"cj\" name=\"cj\" type=\"hidden\" value=\"$ch\">
            ...
            elseif (isset($_REQUEST['da'])) {

                    // delete records from wallet and client - this deletes all occurences of users wallets through userId
                        
                        $clientId = $_REQUEST['da'];
                        
                        $query3 = "DELETE FROM wallet WHERE userId = $clientId";

                        $result4 = mysqli_query($conn2, $query3) or die("ERROR: unable to delete wallet link!");
                        

                        
                        $query4 = "DELETE FROM customer WHERE clientId = $clientId";
                        
                        $result4 = mysqli_query($conn2, $query4) or die("ERROR: unable to delete customer account!");
                        
                        
                        // go back to main screen, but as no user logged in
            ...
            $query6 = "UPDATE customer SET username = '$uname', email = '$email',phoneNum = '$phone', country = '$cty', prefcoin = '$pref'
                      WHERE clientId = $fin";
                    
            $result3 = mysqli_query($conn3, $query6) or die("ERROR: unable to Update records!");

            
            echo "<script> window.location.href =\"admin.php?id=" . $fin . "\"</script>";
