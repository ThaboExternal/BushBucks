...
$urld = "https://rest.coinapi.io/v1/ohlcv/BITSTAMP_SPOT_BTC_USD/history?period_id=1DAY&time_start=$foundD&apikey=8E08E111-7899-4FDF-B473-31F639928280";
//echo $urld;
...
$urlw = "https://rest.coinapi.io/v1/ohlcv/BITSTAMP_SPOT_BTC_USD/history?period_id=7DAY&time_start=$foundW&apikey=8E08E111-7899-4FDF-B473-31F639928280";
//echo $urlw;
...
$urlm = "https://rest.coinapi.io/v1/ohlcv/BITSTAMP_SPOT_BTC_USD/history?period_id=1MTH&time_start=$foundM&apikey=8E08E111-7899-4FDF-B473-31F639928280";
//echo $urlm;
...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
  ...
  function drawExample2() {
    ...
    //remove and add backbone at the end, when testing final product
    var rowData1 = [
      ['Mon', 20, 28, 38, 45],
      ['Tue', 31, 38, 55, 66],
      ['Wed', 50, 55, 77, 80],
...
if (isset($_REQUEST['custName'])){
    ...
    $result = mysqli_query($conn0, $query) or die("ERROR: unable to execute query!");
...
?> 
  ...
  <?php
        ...
        echo "<li class=\"nav-item me-3 me-lg-1\">";
        echo "<a class=\"nav-link\" href=\"trade-btc.php?id=" . $_REQUEST['id'] . "\">";
        ...
        echo "<li class=\"nav-item me-3 me-lg-1\">";
        echo "<a class=\"nav-link\" href=\"reports.php?id=" . $_REQUEST['id'] . "\">";
        echo "<span><i class=\"fas fa-file\"></i></span>";
        echo "</a>";
        echo "</li>";
        echo "</ul>";
...
echo "<li style=\"float: left;\"><a class=\"active\" href=\"trade-btc.php?id=" . $_REQUEST['id'] . "\">BTC</a></li>";
...
echo "<ul class=\"links\" style=\"list-style-type: none;
  ...
  border: 1px solid #e7e7e7;
  background-color: #f3f3f3;\">";
echo "<li style=\"float: left;\"><a class=\"active\" href=\"trade-btc.php\">BTC</a></li>";
...
<div class="card text-center" style="margin-right: 300px;
  ...
  margin-left: 300px;
  padding: 10px;">
    <h2 class="card-title">How much bitcoin do you want to Buy or Sell ?</h2>

<?php  

if(isset($_REQUEST['id'])){

    echo "<form action=\"trade-btc.php\" method=\"POST\">
      
    <input type=\"number\" placeholder=\"$\"id=\"amount\" name=\"amount\" min=\"0\" style = \"font-size:40px; height: 90px;\" required><br>
    ...
    <input type=\"number\" placeholder=\"$\"id=\"code\" name=\"code\" min=\"0\" style = \"font-size:40px; height: 90px;\"><br>
...
<!-- deal with instant buy or sell -->
        ...
        $text = "An immediate-Or-Cancel buy transaction for BTC was completed on the $date . \n";
        ...
        $balance = $amount * $r1['rate'];
          ...
          if($current < $balance ){
	        ...
	        $text = "An immediate-Or-Cancel sell transaction for BTC was cancelled on the $date . \n";
	        ...
	        fclose($file);
	        //close the report
            echo "<script> window.location.href =\"trade-btc.php?id=" . $_REQUEST['custId'] . "\"</script>";
	        ...
	        $text = "An immediate-Or-Cancel sell transaction for BTC was completed on the $date . \n";
...
<!-- deal with stop order buy and sell -->
        ...
        $x2 = file_get_contents('https://rest.coinapi.io/v1/exchangerate/BTC/USD?apikey=D97DE1CA-908D-4512-A65C-DF091720909B');
        ...
        $result8 = mysqli_query($conn3, $query8) or die("ERROR: unable to add transaction (buy order)!");
	        ...
	        $text = "A Stop-limit order [BUY] for BTC was created on the $date . \n";
        ...
        // create long report
	        ...
	        $text = "A Stop-limit order [SELL] for BTC was created on the $date . \n";
